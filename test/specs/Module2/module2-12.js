...
describe('Module 2-12: Thêm phiên bản hiệu lực cho quy trình ', () => {
    before(()=>{
        module1_6();
    })
    ...
    //Thêm phiên bản hiệu lực cho quy trình
    ...
    it('Thêm phiên bản hiệu lực cho quy trình thành công', () =>{
        ...
        //Expect output: chắc chắn đã nhấn nút check 
        expect(check).toBeChecked(true);
