describe('Module 2-2: Sửa tên tài liệu', () => {
    before(()=>{
        module1_5();
    ...
    let inputFileName = '[type="text"]'; 

    it('Sửa tên tài liệu thành công', () =>{

        browser.url(fileRevisionActiveURL);
        $(btnEdit).click();

        $(inputFileName).waitForDisplayed(5000);
        $(inputFileName).setValue('Tài liệu test 1');
