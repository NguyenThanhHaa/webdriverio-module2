describe('Module 2-23: Tham chiếu đến quy trình của một thư mục khác', () => {
    before(()=>{
        module1_3();
    })
    ...
    //Tham chiếu đến quy trình của một thư mục khác
    let categoryURL = process.env.URL_QLQTTM;
    let btnReference ='[title="Tham chiếu quy trình từ thư mục khác"]';
    let inputChoose = '[role="combobox"]';
    let btnConfirm = '[class="btn btn-primary"]';
    
    it('Tham chiếu đến quy trình của một thư mục khác thành công', () =>{
